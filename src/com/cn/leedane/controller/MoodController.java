...
public class MoodController extends BaseController{
	...
	public String send(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.putAll(moodService.updateMoodStatus(json, ConstantsUtil.STATUS_NORMAL, request, user));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String sendDraft(HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			message.putAll(moodService.saveMood(json, user, ConstantsUtil.STATUS_DRAFT, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String sendWord(HttpServletRequest request, HttpServletResponse response){
		long start = System.currentTimeMillis();	
		try {
			if(!checkParams(request, response)){
				printWriter();
			...
			message.putAll(moodService.sendWord(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String sendWordAndLink(HttpServletRequest request, HttpServletResponse response){
		long start = System.currentTimeMillis();	
		try {
			if(!checkParams(request, response)){
				printWriter();
			...
			message.putAll(moodService.sendWordAndLink(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String delete(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.putAll(moodService.deleteMood(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 * @return
	 */
	@RequestMapping("/getPagingMood")
	public String getPagingMood(HttpServletRequest request, HttpServletResponse response){
		try {
			if(!checkParams(request, response)){
				printWriter();
				return null;
			}
			message.putAll(moodService.getMoodByLimit(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String uploadBase64Str(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			//直接保存上传记录
				...
				resIsSuccess = temporaryBase64Service.saveBase64Str(json, user, request);
			}
	...
	public String sendDivideMood(HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			message.putAll(moodService.saveDividedMood(json, user, ConstantsUtil.STATUS_NORMAL, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String downloadBase64Str(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.put("message", filePathService.downloadBase64Str(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getCountByUser(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.put("message", moodService.getCountByUser(json, user, request));
			message.put("isSuccess", true);
			printWriter();
			return null;
		} catch (Exception e) {
	...
	public void detail(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.putAll(moodService.detail(json, user, request, "120x120"));
			printWriter();
			return;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String detailImgs(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.put("message", moodService.detailImgs(json, user, request));
			message.put("isSuccess", true);
			printWriter();
			return null;
		} catch (Exception e) {
