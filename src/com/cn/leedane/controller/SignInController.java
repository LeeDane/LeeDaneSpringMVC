...
public class SignInController extends BaseController{
	...
	public String signIn(HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			int id = JsonUtil.getIntValue(json, "id", user.getId());
			boolean isSave = signInService.saveSignIn(json, userService.findById(id), request);
	...
	public String paging(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			List<Map<String, Object>> result= signInService.getSignInByLimit(json, user, request);
