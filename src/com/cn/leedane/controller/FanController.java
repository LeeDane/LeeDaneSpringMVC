...
public class FanController extends BaseController{
	...
	public String cancel(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.put("isSuccess", fanService.cancel(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String add(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			message.putAll(fanService.addFan(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String isFan(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			message.putAll(fanService.isFan(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String myAttentionPaging(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			message.putAll(fanService.getMyAttentionsLimit(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String toAttentionPaging(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			message.putAll(fanService.getToAttentionsLimit(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String myFansPaging(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			message.putAll(fanService.getMyFansLimit(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String toFansPaging(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			message.putAll(fanService.getToFansLimit(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
