...
public class SearchController extends BaseController{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			int type = JsonUtil.getIntValue(json, "type", 0);
			String keyword = JsonUtil.getStringValue(json, "keyword"); //搜索关键字
	...
	public String user(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.putAll(userService.search(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String mood(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.putAll(moodService.search(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String blog(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			message.putAll(blogService.search(json, user, request));
			printWriter();
			return null;
		} catch (Exception e) {
			e.printStackTrace();
